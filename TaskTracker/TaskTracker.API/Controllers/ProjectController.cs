...
namespace TaskTracker.API.Controllers
{
    ...
    public class ProjectController : ControllerBase
    {
        ...
        public async System.Threading.Tasks.Task<IActionResult> Get(string filterName, int? filterPriority, ProjectStatus? filterStatus, DateTime? filterStartDate, DateTime? filterEndDate, SortingOrder? sortBy)
        {
            try
            {
